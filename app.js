...
function openSFoto() {
    ...
    if (!confirm("Данный альбом создан для выкладывания и просмотра всех фотографий. \nВсе хорошие фотографии которые пройдут модерацию\nбудут выложены  в основной альбом.\nВы действительно хотите перейти на этот ресурс?")) {
        return;
    }
    window.open("https://photos.app.goo.gl/B9upLXgp1t28SvHt8");
